...
if __name__ == "__main__":
    ...
    #-------------------------------------------------------------------------#
    count           = False
    name_classes    = ["RNFL", "GCIPL", "Ghoroidlayer","background"]
    ...
    #-------------------------------------------------------------------------#
    dir_origin_path = r"C:\Users\fdsag\Desktop\GOALS2022-Validation\GOALS2022-Validation\Image/"
    ...
    if mode == "predict":
        ...
        3、如果想要原图和分割图不混合，可以把blend参数设置成False。2
