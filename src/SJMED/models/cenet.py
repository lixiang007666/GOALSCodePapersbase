...
class SELayerwoReduction(nn.Module):
    def __init__(self, channel):
        super(SELayerwoReduction, self).__init__()
        self.avg_pool = nn.AdaptiveAvgPool2d(1)
        self.fc = nn.Sequential(
...
class CE_Net_withSE(nn.Module):
    def __init__(self, num_classes=4, num_channels=3):
        super(CE_Net_withSE, self).__init__()
        ...
        self.seblock1 = SELayer(channel=64, reduction=4)
        self.seblock2 = SELayer(channel=128, reduction=8)
        self.seblock3 = SELayer(channel=256, reduction=16)
        self.seblock4 = SELayer(channel=512, reduction=16)
...
class CE_Net_withECA(nn.Module):
    def __init__(self, num_classes=4, num_channels=3):
        super(CE_Net_withECA, self).__init__()
        ...
        self.seblock1 = eca_layer(channel=64)
        self.seblock2 = eca_layer(channel=128)
        self.seblock3 = eca_layer(channel=256)
        self.seblock4 = eca_layer(channel=512)
...
class deepCE_Net_withECA(nn.Module):
    def __init__(self, num_classes=4, num_channels=3):
        super(deepCE_Net_withECA, self).__init__()
...
class CE_Net_SEwoReduction(nn.Module):
    def __init__(self, num_classes=4, num_channels=3):
        super(CE_Net_SEwoReduction, self).__init__()
        ...
        self.seblock1 = SELayerwoReduction(channel=64)
        self.seblock2 = SELayerwoReduction(channel=128)
        self.seblock3 = SELayerwoReduction(channel=256)
        self.seblock4 = SELayerwoReduction(channel=512)
...
# 输出9通道，包括4通道预测mask，5通道预测layer
class CE_Net_withECA_masklayer(nn.Module):
    def __init__(self, num_classes=9, num_channels=3):
        super(CE_Net_withECA_masklayer, self).__init__()
