...
class OCTDataset(Dataset):
    ...
    def transform(self,img, mask):
        (d, t, sc, sh) = transforms.RandomAffine.get_params(degrees=(-30, 30), translate=(0.3, 0.3),
                                                            scale_ranges=(0.7, 1.3), shears=(-30, 30),
                                                            img_size=img.shape)
...
best_model_path = "model193_1.0549429123383067.pth"
